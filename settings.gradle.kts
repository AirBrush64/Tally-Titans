...
include(":app:adminMainScreen")
include(":app:adminMainScreen:adminMainScreen-data")
include(":app:adminMainScreen:adminMainScreen-view")
include(":app:adminMainScreen:adminMainScreen-view")
include(":app:adminMainScreen:adminMainScreen-viewModel")
include(":app:managementScreen")
include(":app:managementScreen:managementScreen-data")
include(":app:managementScreen:managementScreen-view")
include(":app:managementScreen:managementScreen-viewModel")
